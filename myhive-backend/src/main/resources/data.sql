...
VALUES ('f9eebc99-9c0b-4ef8-bb6d-6bb9bd380aaa', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Prague Castle Tour',
       ...
       ('aa000000-0000-0000-0000-000000000001', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Charles Bridge Walking Tour',
        'Stroll across the iconic 14th-century bridge with a local historian.', 20.00, 90, 'daytime',
        'https://images.unsplash.com/photo-1541849546-216549ae216d?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000002', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Vltava River Cruise',
        'Scenic river cruise with dinner and live jazz music.', 55.00, 150, 'nightlife',
        'https://images.unsplash.com/photo-1592906209472-a36b1f3782ef?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000003', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Old Town Square Tour',
        'Discover the astronomical clock, Tyn Church, and hidden courtyards.', 15.00, 120, 'daytime',
        'https://images.unsplash.com/photo-1458150945447-7fb764c11a92?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000004', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Prague Pub Crawl',
        'Hit 5 bars and clubs in one epic night with free drinks at each stop.', 25.00, 240, 'nightlife',
        'https://images.unsplash.com/photo-1575037614876-c38a4c44f5b8?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000005', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Kayaking on the Vltava',
        'Paddle through the heart of Prague with stunning castle views.', 38.00, 120, 'adventure',
        'https://images.unsplash.com/photo-1472745942893-4b9f730c7668?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000006', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Czech Cooking Class',
        'Learn to cook traditional trdelnik, svickova, and Czech dumplings.', 60.00, 180, 'daytime',
        'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000007', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Petrin Hill Hike',
        'Hike up to the Petrin Tower for panoramic views of the city.', 10.00, 90, 'adventure',
        'https://images.unsplash.com/photo-1562008675-4a1c1e5e5e08?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000008', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Absinth Bar Experience',
        'Taste authentic Czech absinth in a hidden underground bar.', 30.00, 90, 'nightlife',
        'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000009', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Segway City Tour',
        'Glide through Prague on a Segway covering all major landmarks.', 45.00, 120, 'adventure',
        'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000010', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Jewish Quarter Walk',
        'Explore the historic synagogues and the Old Jewish Cemetery.', 22.00, 120, 'daytime',
        'https://images.unsplash.com/photo-1513622470522-26c3c8a854bc?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000011', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Rooftop Jazz Night',
        'Live jazz performance with cocktails on a rooftop overlooking the city.', 35.00, 150, 'nightlife',
        'https://images.unsplash.com/photo-1415201364774-f6f0bb35f28f?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000012', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'E-Scooter Adventure',
        'Zip around Prague on an electric scooter with a guided route.', 28.00, 90, 'adventure',
        'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000013', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Botanical Garden Visit',
        'Relax in the peaceful Troja Botanical Garden with tropical greenhouses.', 8.00, 120, 'daytime',
        'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000014', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Underground Bunker Tour',
        'Descend into Cold War-era nuclear bunkers beneath the city.', 32.00, 90, 'adventure',
        'https://images.unsplash.com/photo-1562159278-1253a58da141?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000015', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Nightclub VIP Experience',
        'VIP entry and table service at Karlovy Lazne, the largest club in Central Europe.', 75.00, 300, 'nightlife',
        'https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000016', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Street Art Walking Tour',
        'Discover hidden murals and graffiti in the Zizkov and Karlin neighborhoods.', 18.00, 120, 'daytime',
        'https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000017', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Hot Air Balloon Ride',
        'Soar above the Bohemian countryside at sunrise.', 180.00, 180, 'adventure',
        'https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?w=800&h=600&fit=crop', CURRENT_TIMESTAMP),
       ('aa000000-0000-0000-0000-000000000018', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Wine Tasting Evening',
        'Discover Moravian wines in a candlelit medieval cellar.', 42.00, 120, 'nightlife',
        'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=800&h=600&fit=crop', CURRENT_TIMESTAMP);
...
INSERT INTO blog_posts (id, title, excerpt, content, category, image_url, date, created_at)
