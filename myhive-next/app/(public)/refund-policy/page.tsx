// SSR Refund & Cancellation Policy — content parity with
    ...
    <div className="policy-page">
      ...
      <section className="policy-section">
        ...
        <p>
          ...
          <Link href="/terms">Terms &amp; Conditions</Link>. All time windows below are counted from the
        ...
        <p>
          As set out in our <Link href="/terms">Terms &amp; Conditions</Link>, a local partner may
