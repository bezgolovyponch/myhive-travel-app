    ...
    <div className="policy-page">
      ...
      <section className="policy-section">
        ...
        <p>
          ...
          <Link href="/privacy-policy">Privacy Policy</Link>, which form part of these Terms.
        </p>
        ...
        <p>
          ...
          our <Link href="/refund-policy">Refund &amp; Cancellation Policy</Link>). We reserve the right
        ...
        <p>
          ...
          <Link href="/refund-policy">Refund &amp; Cancellation Policy</Link>, which sets out the refund
