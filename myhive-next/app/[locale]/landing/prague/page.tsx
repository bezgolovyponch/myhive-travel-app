...
async function loadCatalogue(locale: string): Promise<{
  ...
  const empty = { activities: [], categories: [], destinations: [], destinationSlug: 'prague' };
  try {
    ...
    return { activities, categories, destinations, destinationSlug: prague.slug };
  } catch {
